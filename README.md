...
- [Turns the TV on and switches it to the PC's input](docs/GUIDE.md#tv-control) (Google TV / Android TV or LG webOS over the network), and can put it in standby afterwards
